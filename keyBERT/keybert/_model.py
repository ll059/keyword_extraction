...
class KeyBERT:
    ...
    def extract_keywords(
        ...
        icd10_embeddings: np.array = None,
        ...
        if icd10_embeddings is None:
            print('Computing icd10 embeddings!!!')
        ...
        for index, _ in enumerate(docs):
            ...
            try:
                ...
                # Cosine-based keyword extraction
                    ...
                    distances = cosine_similarity(icd10_embeddings, candidate_embeddings)
                    keywords = [
